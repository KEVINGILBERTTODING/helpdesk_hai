...
{{-- Title --}}
@section('title')
    <title>Daskrimti - Permohonan Selesai</title>
@endsection
            ...
            <ul class="sidebar-menu">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"> <a class="nav-link" href="{{ route('selesaiPermohonan') }}">Permohonan
                                Selesai</a></li>
                ...
                <li class="dropdown">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                            class="fa-solid fa-layer-group"></i> Master</span></a>
                    <ul class="dropdown-menu">
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Daftar Permohonan Telah Selesai.</p>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content modal-dialog-scrollable">
                    <form action="{{ route('filterPermohonan') }}" method="get">
                        ...
                        <div class="modal-body">
                            <div class="form-group col-12" hidden>
                                <input type="number" hidden required name="status" value="1"
                                    class="form-control">
