...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template/main/dist/assets/modules/weather-icon/css/weather-icons.min.css') }}">
  <link rel="stylesheet" href="{{ asset('template/main/dist/assets/modules/weather-icon/css/weather-icons-wind.min.css') }}">
