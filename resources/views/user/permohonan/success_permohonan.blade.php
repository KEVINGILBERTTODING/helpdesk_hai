...
{{-- Title --}}
@section('title')
    <title>HAI - Permohonan Selesai</title>
@endsection
        ...
        <form class="form-inline mr-auto" action="{{ route('search') }}" method="get">
            ...
            <div class="search-element">
                <input class="form-control" type="search" required name="query" placeholder="Search" aria-label="Search"
                    data-width="250">
                <input class="form-control" name="status" hidden type="search" value="1" aria-label="Search"
                    data-width="250">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a class="nav-link" href="layout-transparent.html">Permohonan Selesai</a></li>
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Daftar Permohonan Selesai</h1>
            ...
            <div class="section-body">
                ...
                <p class="section-lead">Daftar semua permohonan yang telah selesai.</p>
